<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('add.brand')}}"><i class="bx bx-right-arrow-alt"></i>Create Brand</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{route("category.add")}}"><i class="bx bx-right-arrow-alt"></i>Create Category</a>
						</li>
